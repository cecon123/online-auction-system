...
public class AuctionClientService {
  ...
  public CompletableFuture<Response<List<AuctionSummaryDto>>> getAuctions() {
    ...
    return socketClient
        .<Void, List<AuctionSummaryDto>>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                List<AuctionSummaryDto> data =
                    jsonMapper.convertList(response.getData(), AuctionSummaryDto.class);
  ...
  public CompletableFuture<Response<AuctionDetailDto>> getAuctionDetail(Long auctionId) {
    ...
    return socketClient
        .<Long, AuctionDetailDto>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                AuctionDetailDto data =
                    jsonMapper.convertData(response.getData(), AuctionDetailDto.class);
                response.setData(data);
              }
              return response;
            });
  ...
  public CompletableFuture<Response<PlaceBidResponse>> placeBid(
      Long auctionId, java.math.BigDecimal amount) {
    ...
    return socketClient
        .<PlaceBidRequest, PlaceBidResponse>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
  ...
  public CompletableFuture<Response<AuctionSummaryDto>> createAuction(
      CreateAuctionRequest createRequest) {
    Request<CreateAuctionRequest> request =
        new Request<>(MessageType.CREATE_AUCTION, null, null, createRequest);

    return socketClient
        .<CreateAuctionRequest, AuctionSummaryDto>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                AuctionSummaryDto data =
                    jsonMapper.convertData(response.getData(), AuctionSummaryDto.class);
                response.setData(data);
              }
              return response;
            });
  ...
  public CompletableFuture<Response<Void>> updateAuction(
      com.auction.common.dto.auction.UpdateAuctionRequest updateRequest) {
    Request<com.auction.common.dto.auction.UpdateAuctionRequest> request =
        new Request<>(MessageType.UPDATE_AUCTION, null, null, updateRequest);
    return socketClient.sendRequest(request);
  }
  ...
  public CompletableFuture<Response<List<PlaceBidResponse>>> getBidHistory(Long auctionId) {
    ...
    return socketClient
        .<Long, List<PlaceBidResponse>>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                List<PlaceBidResponse> data =
                    jsonMapper.convertList(response.getData(), PlaceBidResponse.class);
                response.setData(data);
              }
              return response;
            });
  ...
  public CompletableFuture<Response<com.auction.common.dto.dashboard.SellerStatsDto>>
      getSellerStats() {
    Request<Void> request = new Request<>(MessageType.GET_SELLER_STATS, null, null, null);

    return socketClient
        .<Void, com.auction.common.dto.dashboard.SellerStatsDto>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                com.auction.common.dto.dashboard.SellerStatsDto data =
                    jsonMapper.convertData(
                        response.getData(), com.auction.common.dto.dashboard.SellerStatsDto.class);
                response.setData(data);
              }
              return response;
            });
  ...
  public CompletableFuture<Response<com.auction.common.dto.dashboard.DashboardDto>> getDashboard() {
    ...
    return socketClient
        .<Void, com.auction.common.dto.dashboard.DashboardDto>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                com.auction.common.dto.dashboard.DashboardDto data =
                    jsonMapper.convertData(
                        response.getData(), com.auction.common.dto.dashboard.DashboardDto.class);
                response.setData(data);
              }
              return response;
            });
  ...
  public CompletableFuture<Response<List<com.auction.common.dto.bid.BidHistoryDto>>>
      getUserBidHistory() {
    Request<Void> request = new Request<>(MessageType.GET_USER_BID_HISTORY, null, null, null);

    return socketClient
        .<Void, List<com.auction.common.dto.bid.BidHistoryDto>>sendRequest(request)
        .thenApply(
            response -> {
              if (response.isSuccess()) {
                List<com.auction.common.dto.bid.BidHistoryDto> data =
                    jsonMapper.convertList(
                        response.getData(), com.auction.common.dto.bid.BidHistoryDto.class);
                response.setData(data);
              }
              return response;
            });
