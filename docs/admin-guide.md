...
- **Tài khoản demo khác:** `seller01`, `seller02`, `bidder01`, `bidder02` đều dùng password `123456`.
...
2. Đăng nhập vào **Client A** với tài khoản `admin` / `123456`.
3. Đăng nhập vào **Client B** với tài khoản `seller01` / `123456`.
