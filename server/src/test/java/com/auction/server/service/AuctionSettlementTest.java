...
class AuctionSettlementTest {
    ...
    void setUp() {
        ...
        bidService = new BidService(auctionDao, new SQLiteBidDao(), userDao, new SQLiteAutoBidDao(), walletService);
        ...
        sellerId = userDao.create("seller_" + suffix, "hash", "Seller", Role.SELLER, new BigDecimal("1000"), BigDecimal.ZERO);
        bidderId = userDao.create("bidder_" + suffix, "hash", "Bidder", Role.BIDDER, new BigDecimal("5000"), BigDecimal.ZERO);
        
        Electronics item = new Electronics(0, sellerId, "Test Item", "Desc", "New", new BigDecimal("100"), null, "Brand", "Model", LocalDateTime.now());
