...
public class SQLiteAutoBidDao implements AutoBidDao {
    ...
    @Override
    public Optional<AutoBidRule> findByAuctionAndBidder(
        long auctionId,
        long bidderId
    ) {
    ...
    public List<AutoBidRule> findActiveByAuction(long auctionId) {
        ...
        try (
            ...
            logger.error(
                "Database error during findActiveByAuction: Auction {}",
                auctionId,
                e
            );
    ...
    public void delete(long auctionId, long bidderId) {
        ...
        try (
            ...
            logger.error(
                "Database error during delete auto bid: Auction {}, Bidder {}",
                auctionId,
                bidderId,
                e
            );
