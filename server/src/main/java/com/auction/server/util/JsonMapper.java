 ...
 * Therefore this mapper must NOT use pretty printing.
 */
public final class JsonMapper {
     ...
     *
     * Gson deserializes Request<?>.data as a generic object/map, so the router
     * must convert it again after it knows the MessageType.
     */
