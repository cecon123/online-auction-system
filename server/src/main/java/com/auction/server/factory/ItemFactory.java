 ...
 *
 * The system has an abstract Item class and concrete subclasses:
 * Electronics, Art, Vehicle.
 *
 * Instead of scattering object creation logic across services/controllers,
 * this factory centralizes the creation of Item objects based on ItemType.
 */
public class ItemFactory {
     ...
     *
     * Some fields are only meaningful for specific item types:
